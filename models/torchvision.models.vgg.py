...
[docs]class VGG11_Weights(WeightsEnum):
...
[docs]class VGG11_BN_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
...
[docs]class VGG13_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
...
[docs]class VGG13_BN_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
...
[docs]class VGG16_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
